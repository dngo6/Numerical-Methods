function [c, rel_error] = lecture5Euler()
clear
clc
...
while t(i) < end_time %c1(i) > 1 || c2(i) > 1 || c2(i) > 1 %while the concentration of each pond is not 1
    ...
    [k1, k2, k3] = derivs_lec5(t(i), c1(i), c2(i), c3(i), del_t);
    
    c1(i+1) = c1(i) + k1*del_t;
...
grid
title('HW 5: Comparison of Eulers solution for three reactors with recirculation.')
